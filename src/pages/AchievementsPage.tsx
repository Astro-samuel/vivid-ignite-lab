      ...
      <div className="px-8 py-10 max-w-4xl mx-auto">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-2">
            <Trophy size={24} style={{ color: "#FFD700" }} className="text-glow-gold" />
            ...
            {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day, i) => (
              <div key={day} className="flex-1 text-center">
                <div
                  ...
                  style={{
                    background: streakDays[i] ? "linear-gradient(135deg, #FF4500, #FF6B35)" : "hsl(229, 42%, 22%)",
                    boxShadow: streakDays[i] ? "0 0 12px rgba(255,69,0,0.4)" : "none",
                  }}
                >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {filtered.map((ach) => (
            <div
              key={ach.id}
              className="card-neon p-5 transition-all duration-300"
              style={
                ach.unlocked
                  ? { borderColor: `${ach.color}44`, boxShadow: `0 0 15px ${ach.color}11` }
                  : { opacity: 0.7 }
              }
            >
              <div className="flex items-start gap-4">
                <div
                  ...
                  style={{
                    background: ach.unlocked ? `${ach.color}22` : "hsl(229, 42%, 22%)",
                    border: `1px solid ${ach.unlocked ? ach.color + "44" : "hsl(229, 42%, 28%)"}`,
                  }}
                >
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <h3 className="font-bold text-sm" style={{ color: ach.unlocked ? "#FFFFFF" : "hsl(226, 35%, 72%)" }}>
                        {ach.title}
                      </h3>
                      ...
                      <div className="progress-neon h-1.5">
                        <div
                          ...
                          style={{
                            ...
                            background: `linear-gradient(90deg, ${ach.color}, ${ach.color}88)`,
                  ...
                  {ach.unlocked && (
                    <div className="flex items-center gap-1 mt-2">
                      ...
                      <span className="text-xs" style={{ color: "#00FF88" }}>Unlocked!</span>
                    </div>
                  )}
                </div>
              </div>
